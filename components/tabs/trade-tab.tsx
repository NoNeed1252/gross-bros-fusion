...
export function TradeTab({
  ...
  useEffect(() => {
    ...
    if (!savedAddress) {
      savedAddress = 'rGros' + Math.random().toString(36).substring(2, 10).toUpperCase() + 'BotXRP'
        ...
        <div className="rounded-xl border border-zinc-800 bg-zinc-950/80 p-5 backdrop-blur-md">
          <div className="flex items-center justify-between pb-3 text-xs uppercase tracking-wider text-zinc-400">
            ...
            <div className="text-3xl font-extrabold text-zinc-100">
              {botBalance} <span className="text-sm font-normal text-zinc-400">XRP
            
            
              <span className="truncate">{botAddress || 'Generating...'}
              {botAddress && (
                <button
                  onClick={handleCopy}
          ...
          {/* Quick Transfer Form */}
            ...
            <div className="text-xs font-semibold uppercase text-zinc-300">
              ...
              Withdraw All to Main Xaman Wallet
            
          
        

        {/* Main Wallet Link Overview */}
          ...
          <div>
            <div className="flex items-center justify-between pb-3 text-xs uppercase tracking-wider text-zinc-400">
              ...
              <div className="text-2xl font-bold text-zinc-100">
                {mainBalance || '0.00'} <span className="text-sm font-normal text-zinc-400">XRP
            ...
            <div className="flex items-center gap-1.5 font-semibold text-zinc-200">
              ...
              Your main Xaman wallet and NFTs remain completely untouched. The AI Bot only trades using funds in this isolated Bot Wallet
